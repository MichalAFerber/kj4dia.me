...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#image01', { style: 'fade-right', speed: 1000, intensity: 0, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text02', { style: 'fade-right', speed: 1000, intensity: 1, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text01', { style: 'fade-right', speed: 1000, intensity: 2, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#buttons02', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', state: true, replay: false });
		onvisible.add('#text04', { style: 'fade-right', speed: 1000, intensity: 2, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#buttons01', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', state: true, replay: false });
		onvisible.add('#text03', { style: 'fade-right', speed: 1000, intensity: 2, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#container01', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text05', { style: 'fade-right', speed: 1000, intensity: 2, threshold: 3, delay: 0, state: true, replay: false });
